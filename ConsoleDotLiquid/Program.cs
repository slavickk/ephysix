...
@startuml
title =ACS+CCFA(Event processing)+TWO/TX
...
participant ""Event\nProcessing"" as CCFA order 40 #99FF99
legend left
...
autonumber
  == AReq ==
  [o->ACS:Http
  ACS -[#FF3333]> CCFA : <b>TECAP: TdsPrepareAuth</b>/Req
  CCFA -[#00FF00]> IU: <b>OPEN API: TdsPrepareAuth</b>/Req
  IU -[#00FF00]> TWO: <b>OPEN API: TdsPrepareAuth</b>/Req
  TWO -[#00FF00]>ACS : <b>OPEN API: TdsPrepareAuth+Extensions(CCFAResult)</b>/Resp
  ACS->[:Http
