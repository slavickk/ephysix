...
namespace TestFrontInterface
{
    ...
    public class UnitTest1
    {
        ...
        public async Task TestReceiverExecs()
        {
            ...
            var arr = await ReceiverHelper.getExamples("C:\\D\\OUT_TIC", null, "TransactionAmount");
            arr = await ReceiverHelper.getExamples("C:\\D\\OUT_TIC", arr, "TransactionAmount","2568");
