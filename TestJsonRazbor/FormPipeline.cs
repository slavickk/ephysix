...
namespace TestJsonRazbor
{
    public partial class FormPipeline : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            FormTypeDefiner frm = new FormTypeDefiner() { tDefine = typeof(IReceiver), tObject = (currentStep.receiver == null) ? new HTTPReceiverSwagger/*PacketBeatReceiver*/() : currentStep.receiver };
